        ...
        <tbody>
            ...
            if (mysqli_num_rows($RS) > 0) {
                foreach ($RS as $dados) {
                    ...
                    echo "<td>
                        <a href='alterar_quarto.php?id_quarto=" . $dados['id_quarto'] . "' class='btn btn-primary btn-sm me-1'>Alterar</a>
                        <a href='excluir_quarto.php?id_quarto=" . $dados['id_quarto'] . "' class='btn btn-danger btn-sm' onclick='return confirm(Deseja realmente excluir?)'>Excluir</a>
                    </td>";
                    echo "</tr>";
                }
            } else {
